...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Se pueden incluir relaciones y aplicar filtros a través de parámetros en la consulta. <br>.
           <br> <b>Filtros disponibles para los Listados (index) :</b>
       <br> - <b>select</b>: Permite seleccionar campos específicos del autor. Ejemplo: `select=id,nombre` <br>
    ...
    'ui' => [
        ...
        // Construye la URL desde APP_URL si está definida, con fallback a la ruta absoluta desde la raíz del sitio.
        'logo' => (env('APP_URL') ? rtrim(env('APP_URL'), '/') . '/img/LogoServiciosInformaticos.jpg' : '/img/LogoServiciosInformaticos.jpg'),
    ...
    'middleware' => [
        'web',
        RestrictedDocsAccess::class,  //solo se ve en local, se comenta para produccion
    ],
