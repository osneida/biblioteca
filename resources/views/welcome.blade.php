    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Sistema de Gestión Bibliotecaria</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">API para la Gestión Bibliotecaria.
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            <a href="{{ rtrim(env('APP_URL'), '/') . '/docs/api#/' }}" target=""
